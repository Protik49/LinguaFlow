          ...
          <div className="overflow-y-auto flex-1">
            ...
            {tab === "setup" && (
              <div className="px-4 py-3 space-y-3">
                ...
                <button
                  onClick={saveKeys}
                  className="w-full py-1.5 text-xs font-medium bg-brand-500 hover:bg-brand-600 text-white rounded-lg transition-colors"
                >
                  Save Keys
                </button>
                ...
                {filteredVocab.length === 0 ? (
                  <div className="text-center py-8">
                    <p className="text-xs text-gray-400">
                      {vocab.length === 0
                        ? "Click a word and Save to add it to your vocabulary."
